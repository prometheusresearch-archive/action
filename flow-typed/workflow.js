...
declare module 'workflow' {
  declare export type Result<T> = {type: 'Error', error: string} | {type: 'Ok', value: T};
  ...
  declare export function bind(query: UntypedQuery, state: State): Result<{ui: UI, state: State}>;
  declare export function next(state: State): Array<State>;

  declare export function getQuery(ui: UI): Query;
